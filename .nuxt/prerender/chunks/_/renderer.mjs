import process from 'node:process';globalThis._importMeta_=globalThis._importMeta_||{url:"file:///_entry.js",env:process.env};import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///home/evilcorp/projects/site/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { eventHandler, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getQuery, createError, appendResponseHeader, getResponseStatusText } from 'file:///home/evilcorp/projects/site/node_modules/h3/dist/index.mjs';
import { stringify, uneval } from 'file:///home/evilcorp/projects/site/node_modules/devalue/index.js';
import { joinRelativeURL, joinURL, withoutTrailingSlash } from 'file:///home/evilcorp/projects/site/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///home/evilcorp/projects/site/node_modules/vue/server-renderer/index.mjs';
import { propsToString, renderSSRHead } from 'file:///home/evilcorp/projects/site/node_modules/@unhead/ssr/dist/index.mjs';
import { u as useRuntimeConfig, a as useNitroApp, b as useStorage, g as getRouteRules } from '../runtime.mjs';
import { createServerHead as createServerHead$1, CapoPlugin } from 'file:///home/evilcorp/projects/site/node_modules/unhead/dist/index.mjs';
import { version, unref } from 'file:///home/evilcorp/projects/site/node_modules/vue/index.mjs';
import { defineHeadPlugin } from 'file:///home/evilcorp/projects/site/node_modules/@unhead/shared/dist/index.mjs';
